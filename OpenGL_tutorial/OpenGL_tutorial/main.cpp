...
int main()
{
	...
	projection = glm::perspective(glm::radians(45.0f), (float)screenWidth / (float)screenHeight, 0.1f, 10.0f);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		float scaleAmount = 0.5f * sin(frequency * time) + 1.0f;
